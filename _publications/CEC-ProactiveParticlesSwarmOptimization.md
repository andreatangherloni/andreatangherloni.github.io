...
paperurl: 'https://ieeexplore.ieee.org/document/7969538'
citation: 'Tangherloni A., Rundo L., Nobile M.S. (2017). Proactive Particles in Swarm Optimization: A settings-free algorithm for real-parameter single objective optimization problems. In IEEE Congress on Evolutionary Computation (CEC), IEEE.'
---
